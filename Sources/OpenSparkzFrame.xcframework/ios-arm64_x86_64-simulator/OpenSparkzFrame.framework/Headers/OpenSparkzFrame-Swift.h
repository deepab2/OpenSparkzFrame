...
#ifndef OPENSPARKZFRAME_SWIFT_H
#define OPENSPARKZFRAME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OpenSparkzFrame",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC15OpenSparkzFrame9ApiHelper")
...
@property (nonatomic, copy) IBInspectable NSString * _Nonnull configureGetAddCardEndPoint;
@property (nonatomic, copy) IBInspectable NSString * _Nonnull configureRegisterCardEndPoint;
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull defaultEditTextColor;
...
@property (nonatomic, strong) IBInspectable UIFont * _Nonnull fontFamily;
@property (nonatomic, copy) IBInspectable NSString * _Nonnull cardNumberErrorMessage;
@property (nonatomic, copy) IBInspectable NSString * _Nonnull cardExpiryErrorMessage;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC15OpenSparkzFrame19ValidationTextField") SWIFT_AVAILABILITY(ios,introduced=9.0)
@interface ValidationTextField : UITextField
@property (nonatomic) IBInspectable BOOL isShowTitle;
@property (nonatomic) IBInspectable BOOL isUseTitle;
...
@property (nonatomic, strong) IBInspectable UIFont * _Nonnull errorFont;
